...
#define  P_WATER_AUTO_DROP              P4.4
#define  TURN_ON_WATER_AUTO_DROP()      do{ P_WATER_AUTO_DROP = 1; }while(0)
#define  TURN_OFF_WATER_AUTO_DROP()     do{ P_WATER_AUTO_DROP = 0; }while(0)
#define  GET_STATUS_WATER_AUTO_DROP()   ( P_WATER_AUTO_DROP )
